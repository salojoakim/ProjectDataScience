...
from adk_agent.utils.deployment import (
    parse_env_vars,
    print_deployment_success,
    write_deployment_metadata,
)
from adk_agent.utils.gcs import create_bucket_if_not_exists
from adk_agent.utils.tracing import CloudTraceLoggingSpanExporter
from adk_agent.utils.typing import Feedback
...
@click.option(
    "--agent-name",
    default="messenging-price-analyzer",
...
def deploy_agent_engine_app(
    ...
    artifacts_bucket_name = f"{project}-messenging-price-analyzer-logs"
